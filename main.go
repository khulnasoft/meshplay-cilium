...
import (
	...
	"github.com/khulnasoft/meshplay-cilium/build"
	"github.com/khulnasoft/meshplay-cilium/cilium"
	"github.com/khulnasoft/meshplay-cilium/cilium/oam"
	"github.com/khulnasoft/meshplay-cilium/internal/config"
...
func meshplayServerAddress() string {
...
func registerCapabilities(port string, log logger.Handler) {
	...
	if err := oam.RegisterMeshModelComponents(instanceID, meshplayServerAddress(), serviceAddress(), port); err != nil {
		log.Info(err.Error())
	}
...
func registerWorkloads(port string, log logger.Handler) {
	...
	log.Info("Registering workloads with Meshplay Server for version ", version)
